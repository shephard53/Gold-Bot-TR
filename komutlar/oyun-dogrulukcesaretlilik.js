...
exports.run = async (bot, message, args) => {
    var dogruluk = ['Telefonunda arattığın en son şey nedir ?', 'Sevgilin Oldumu', 'Hiç Şerefsizlik Yaptınmı', 'hiç Sevgilini Aldattınmı', 'Bir sabah karşı cins olarak uyansaydın ilk yapacağın şey ne olurdu ?', 'Sokakta yere bir şey düşürdüğünde hiç bir şey olmamış gibi alıp ağzına attın mı ?', 'En utanç duyduğun şey ?','En Kötü Anın ne ?','En sevmediğin kişi kim ?','Geçmişte yaşadığın en kötü olay ?','Sahil olduğunu en büyük ve kötü alışkanlık','Seni en çok ne etkiler ','Burnunu karıştırirmisin']
    var cesaret = ['İğrenç bir ses tonuyla şarkı söyle', 'Discordda Bulundugun Bir Sunucudaki Kıza Özelden Yavşa', 'Bugün yaptığın bir şeyle alakalı uydurma kısa, komik bir hikaye anlat', 'Whatsappındaki son mesajlaşmanı bize oku', 'Çok yüksek bir sesle 3 saniye bağır', 'Şimdiye kadar yaptığın en büyük şey?']
